...
I've led Lean Six Sigma workshops and co-facilitated C-level design discussions at a healthcare technology company. I've built Python utilities for federal data governance teams and designed integrations between ServiceNow, Alation, and PowerBI for a regulatory agency. I've mentored research staff at UT Austin on a 1,000-participant longitudinal study. And in the last year and a half, I've built and deployed a portfolio of GenAI applications — RAG systems, knowledge graph pipelines, multi-LLM platforms, a memorial knowledge graph — that are live and running, not sitting in notebooks.
